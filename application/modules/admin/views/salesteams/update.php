					                    ...
					                    <div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="invoice_target" value="<?php echo $salesteam->invoice_target;?>" class="form-control">
					                          ...
					                          <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="invoice_forecast" value="<?php echo $salesteam->invoice_forecast;?>" class="form-control">
                          					 ...
                          					 <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                ...
					                                <option value="<?php echo $staff->id;?>" <?php if($salesteam->team_leader==$staff->id){?>selected<?php }?>><?php echo $staff->first_name.' '. $staff->last_name;?></option>
					                                <?php }?> 
					                                </select>
					                              </div>
					                            </div>
