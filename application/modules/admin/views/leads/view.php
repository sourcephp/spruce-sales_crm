...
$(document).ready(function() {
 ...
 <!-- BEGIN PAGE CONTENT -->
        ...
        <div class="header">
            <h2><strong><?php echo $lead->opportunity;?></strong></h2> 
					                     ...
					                     <div class="row">
                          					<div class="col-sm-6">
					                            ...
					                            <div class="col-sm-12">
					                              ...
					                              <div class="col-sm-8 append-icon">					                                 
					                                <?php echo customer_name($lead->customer)->name; ?>   
					                              </div>
					                            ...
					                            <div class="col-sm-12">
					                              ...
					                              <div class="col-sm-8 append-icon">					                                 
					                                <?php echo $this->salesteams_model->get_salesteam($lead->sales_team_id)->salesteam; ?>   
					                              </div>
