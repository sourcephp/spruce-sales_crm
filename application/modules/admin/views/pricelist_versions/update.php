...
$(document).ready(function() {
	$("form[name='update_pricelist_versions']").submit(function(e) {
        var formData = new FormData($(this)[0]);

        $.ajax({
            url: "<?php echo base_url('admin/pricelist_versions/update_process'); ?>",
            type: "POST",
            data: formData,
            async: false,
...
function delete_price_ver_product( product_id )
 { 
    ...
    $.ajax({
        ...
        type: "GET",
        url: "<?php echo base_url('admin/pricelist_versions/delete_price_ver_product' ); ?>/" + product_id,
        success: function(msg)
        {
			if( msg != '' )
            {	 
 ...
 <!-- BEGIN PAGE CONTENT -->
        ...
        <div class="header">
            <h2><strong>Update Pricelist Version</strong></h2>            
          </div>
           <div class="row">
           	<div class="col-md-12">
                  <div class="panel">
                     ...
                     <div class="panel-content">
				            ...
				            <form id="update_pricelist_versions" name="update_pricelist_versions" class="form-validation" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                        				 
                        				 <input  type="hidden" name="pricelist_version_id" value="<?php echo $pricelist_version->id;?>"/> 
                          					...
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="pricelist_version_name" value="<?php echo $pricelist_version->pricelist_version_name;?>" class="form-control">
					                          ...
					                          <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                               ...
					                               <input type="text" name="start_date" id="start_date" value="<?php echo date('m/d/Y',$pricelist_version->start_date);?>" class="date-picker form-control">
					                              </div>
					                            </div>
					                          </div>
					                            ...
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                               ...
					                               <select name="pricelist_id" class="form-control" data-search="true">
					                                ...
					                                <option value="<?php echo $pricelist->id;?>" <?php if($pricelist_version->pricelist_id==$pricelist->id){?>selected<?php }?>><?php echo $pricelist->pricelist_name;?></option>
					                                <?php }?> 
					                                </select>
					                              </div>
					                            </div>
											...
											<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                               ...
					                               <input type="text" name="end_date" id="end_date" value="<?php echo date('m/d/Y',$pricelist_version->end_date);?>" class="date-picker form-control">
					                              </div>
					                            </div>
					                          </div>
					                    </div>
					                    <div class="row">
					                    	...
					                    	<div class="col-sm-6">
				                              ...
				                              <div class="append-icon">
				                                <input type="checkbox" name="active" value="1" <?php if($pricelist_version->active=='1'){?>checked<?php }?> data-checkbox="icheckbox_square-blue"/> 
					                    	 ...
					                    	 <div class="panel-content">
                									 ...
                									 <table class="table">
									                    ...
									                    <tbody id="InputsWrapper">
									                     ...
									                     <td>
	 <input type="hidden" name="pricelist_ver_product_id[]" id="pricelist_ver_product_id" value="<?php echo $pricelist_ver_product->id;?>" readonly="">
	 <input type="hidden" name="p_id[]" id="p_id" value="<?php echo $pricelist_ver_product->product_id;?>" readonly="">
									                     <input type="text" name="product_name[]" id="product_name" value="<?php echo $pricelist_ver_product->product_name;?>" class="form-control" readonly=""></td>
									                     <td><textarea name="description[]&quot;" id="description" rows="2" class="form-control" readonly=""><?php echo $pricelist_ver_product->discription;?></textarea></td>
									                     <td><input type="text" name="product_price[]" id="product_price" value="<?php echo $pricelist_ver_product->price;?>" class="form-control" readonly=""></td>
									                     <td><input type="text" name="special_price[]" id="special_price2" value="<?php echo $pricelist_ver_product->special_price;?>" class="form-control"></td>
									                     <td><a href="javascript:void(0)" class="delete btn btn-sm btn-danger removeclass" onclick="delete_price_ver_product(<?php echo $pricelist_ver_product->id;?>)"><i class="icons-office-52"></i></a></td></tr> 
