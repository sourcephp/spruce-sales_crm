        ...
        <div class="page-content">
            ...
            <div class="row">
                            <div class="col-md-12" style="float:right; padding-top:10px;">                           
                              ...
                              <a href="<?php echo base_url('admin/invoices/receive_payments_number/'); ?>" class="btn btn-primary" style="float:right; color:white; background-color:#0C59B0;">RECIEVE PAYMENT</a>
                      ...
                      <?php if( ! empty($invoices) ){?>
					    <?php foreach( $invoices as $invoice){ ?>
	                      <tr id="invoice_id_<?php echo $invoice->id; ?>">
	                        ...
	                        <td><?php if($invoice->status=="Paid Invoice"){?><a href="javascript:void(0);" class="btn btn-sm btn-success"><i class="fa fa-check"></i>  RECIEVED PAYMENT</a><?php }else{?><a href="<?php echo base_url('admin/invoices/receive_payments/'.$invoice->id); ?>" class="btn btn-sm btn-danger"><i class="fa fa-plus"></i>  RECIEVE PAYMENT</a><?php }?></td>
