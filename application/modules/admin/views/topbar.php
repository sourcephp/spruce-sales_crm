...
<div class="topbar">
          <div class="header-left">
           ...
           <li class="<?php echo is_active_menu('mailbox'); ?>"><a href="<?php echo base_url('admin/mailbox'); ?>"><!--<span class="pull-right badge badge-primary">8</span>--><i class="fa fa-envelope"></i><span>Email</span></a></li>
